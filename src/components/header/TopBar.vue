<template>
  <div
    class="hidden lg:flex items-center justify-between px-6 py-1.5 w-full text-xs font-light text-muted-foreground bg-background/80 backdrop-blur-md rounded-none"
  >
