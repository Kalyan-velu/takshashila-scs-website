...
/**
 * Pushes a custom analytics event to the Google Tag Manager dataLayer.
 * Safe to call from the main thread — Partytown forwards `dataLayer.push`
 * calls into the worker where GTM actually runs (see astro.config.mjs).
 */
